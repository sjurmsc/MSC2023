...
if __name__ == '__main__':
    ...
    for i, (train_index, test_index) in enumerate(cv.split(X_train, y_train, groups_train)):
        ...
        X_train_cv, X_test_cv = X_train[tf.convert_to_tensor(train_index, dtype=tf.int32)], X_train[tf.convert_to_tensor(test_index, dtype=tf.int32)]
        y_train_cv, y_test_cv = y_train[tf.convert_to_tensor(train_index, dtype=tf.int32)], y_train[tf.convert_to_tensor(test_index, dtype=tf.int32)]
