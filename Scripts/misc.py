...
def karpathy_lstm():
    """This function creates a simple LSTM model based on the Karpathy blog post."""
    import keras
...
def train_karpathy_lstm():
    """This function trains the Karpathy LSTM model."""
    ...
    prompt = [char2idx[c] for c in prompt]
    ...
    for i in range(num_generate):
        ...
        prompt = np.array([[predicted_id]])
        text_generated.append(idx2char[predicted_id])
    
    print ('Anders: {}'.format(''.join(text_generated)))
