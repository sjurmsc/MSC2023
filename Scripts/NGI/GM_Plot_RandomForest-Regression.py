...
def plot_data_pred(df, df_RF_scores, df_RF_reg, df_unit_col, path_pdf):
    ...
    for loc in loclist:
        ...
        print('Loc:', int(loc))
        # path png
        path_png = '../../09-Results/Stage-01/Final/Plots_RFreg/RFreg-Location_%s.png' %(loc_txt)
        ...
        legend_elements = [Line2D([0], [0], color='w', marker='o', markerfacecolor='k', markersize=5, label='RFreg prediction')]
...
axs, fig = plot_data_pred(df, df_RF_scores, df_RF_reg, df_unit_col, path_pdf)
