...
def plot_data_pred(df, df_mev, df_unit_col, path_pdf):
    ...
    for loc in loclist:
        ...
        print('Loc:', int(loc))
        # path png
        path_png = '../../09-Results/Stage-01/Final/Plots_RFclass/RFclass-Location_%s.png' %(loc_txt)
        ...
        legend_elements = [Line2D([0], [0], color='lightgray', lw=8, label='RF Classification')]
...
axs, fig = plot_data_pred(df, df_mev, df_unit_col, path_pdf)
