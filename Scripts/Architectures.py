...
def LSTM_encoder(latent_features, image_width):
    ...
    lstm_encoder = keras.Sequential([
        keras.layers.InputLayer(input_shape=image_shape),
        keras.layers.ConvLSTM1D(32, (3, 3), activation='relu', padding='same'),
        keras.layers.ConvLSTM1D(32, (3, 3), activation='relu', padding='same'),
        keras.layers.Conv2D(32, (3, 3), strides=(1, 2), activation='relu', padding='same'),
        keras.layers.ConvLSTM1D(16, (3, 3), activation='relu', padding='same'),
        keras.layers.ConvLSTM1D(latent_features, (3, 3), activation='relu', padding='same'),
