...
def CNN_pyramidal_decoder(latent_features, image_width):
    ...
    x = keras.layers.Conv2DTranspose(32, (3, 3), activation='relu', padding='same')(x)
    b2 = keras.layers.Add()([b2, x])
    b2 = keras.layers.Conv2DTranspose(32, (3, 3), activation='relu', strides=(1, 2), padding='same')(b2) # Increase horizontal dimension by 2, and vertical by factor 2
    x = keras.layers.Conv2DTranspose(32, (3, 3), activation='relu', padding='same')(b2)
    x = keras.layers.Conv2DTranspose(32, (3, 3), activation='relu', padding='same')(x)
    x = keras.layers.Conv2DTranspose(32, (3, 3), activation='relu', padding='same')(x)
    b2 = keras.layers.Add()([b2, x])

    x = keras.layers.ZeroPadding2D(padding=((2, 2), (0, 0)))(b2)
